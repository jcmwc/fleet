...
<?cache_require("rapport-menu.php")?>
  <div class="main_resize backgroundbloc ajustmargin">
    <div class="resize rapport_flotte">
      ...
      <span class="info_rapportkm">
        ...
        <?=showexport("flotte03",array("Nom","Activité","Conduite","Arrêt","Distance","Vit.max.","Conso."),array("nomvehicule","amplitude","datediff","arret","km","vitesse","conso"))?>
      </span>
    </div>
  </div>
  <div class="bottom_content">
    ...
    <script src="<?=__racineweb__?>/tpl/js/rapport-flotte03.js"></script>
