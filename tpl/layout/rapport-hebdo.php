...
<?cache_require("rapport-menu.php")?>
  <div class="main_resize backgroundbloc ajustmargin">
    <div class="resize rapport_flotte">
      <h1 class="bcktitle ajust_title ">Rapport hebdomadaire</h1>
      <form class="form_rapport_vehicule" action="<?=urlp($_GET["arbre"])?>" method="post">
      <input type="hidden" value="hebdo" name="template">
        ...
        <div class="decale">
         ...
         <p>
          <label> Semaine n° :</label>
           <span><?=date2week($_POST["date_jour"])?></span>
         </p>
          <p>
            <label>Date : </label>
      ...
      <span class="info_rapportkm">
        ...
        <?=showexport("hebdo",array("Date","Début","Fin","Ampl.","Conduite","Arrêt","Distance","Vit.max."),array("date","debut","fin","datediff","conduite","arret","km","vitessemax"))?>
      </span> 
    </div>
  </div>
  <div class="bottom_content">
    ...
    <script src="<?=__racineweb__?>/tpl/js/rapport-hebdo.js"></script>
