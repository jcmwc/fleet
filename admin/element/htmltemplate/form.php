<?php
$tabparam=explode(",",substr($searchstring[1],0,-1));
if($_GET["mode"]=="visu"||$_GET["mode"]=="suppr"){
  ...
  top.editor[indice] = "'.$tabelem[0].'|'.$tabparam[0].'|400|Template|'.__racineadminmenu__.'/fck_template/'.((count($tabparam)>1)?$tabparam[1]:"fcktemplates.xml").'";
  </script>';
}
?>