...
//			noop(); // keep JSLint happy
		...
		if(!nodeTitle){
      if(data.tooltipuser){
      var tooltip = data.tooltip ? ' title="' + data.tooltip.replace(/\"/g, '&quot;') + ' / ' + data.tooltipuser.replace(/\"/g, '&quot;') +'"' : '';
      }else{
...
//				this.tree.logDebug("nodeTitle: " + nodeTitle);
    ...
    //modif jc pour le verou
    if ( data.verrou ) {
      nodeTitle+="<img src='" + opts.imagePath + opts.defaultVerrouImg + "' alt='' />"
    }
		res += nodeTitle;
		return res;
	},
...
//				this.span.innerHTML = this._getInnerHtml();
			...
			this.span.innerHTML = this._getInnerHtml();
      //this.span
      $(this.span).find("a").tooltip({showURL: false});
