 ...
 */
    ...
    $currentTrigger = null,
        ...
        op = {
                ...
                $.each(opt.items, function (key, item) {
                    ...
                    if (typeof item == "string") {
                        ...
                        if (item.type && item.type != 'sub' && item.type != 'html') {
                            $input.bind('focus', handle.focusInput).bind('blur', handle.blurInput);
            ...
            layer: function (opt, zIndex) {
                ...
                return opt.$layer = $('<div id="context-menu-layer" style="position:fixed; z-index:' + zIndex + '; top:0; left:0; opacity: 0;"></div>').css({
                    height: $win.height(),
                    width: $win.width(),
                    display: 'block'
                }).data('contextMenuRoot', opt).insertBefore(this).bind('mousedown', handle.layerClick);
            }
        };
    ...
    $.contextMenu = function (operation, options) {
        ...
        case 'create':
            ...
            switch (o.trigger) {
            case 'hover':
                $body.delegate(o.selector, 'mouseenter' + o.ns, o, handle.mouseenter).delegate(o.selector, 'mouseleave' + o.ns, o, handle.mouseleave);
                break;
