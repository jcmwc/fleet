...
FCKConfig.Plugins.Add( 'flvPlayer','fr,en,pl,es');
...
FCKConfig.ToolbarSets["Custom"] = [
	['Source'],['Bold','Italic','Underline','FontFormat']
] ;
...
FCKConfig.FontSizes		= '8px;9px;10px;11px;12px;14px;16px;18px;20px;22px;24px;26px;28px;30px;' ;

FCKConfig.StylesXmlPath		= FCKConfig.EditorPath + 'fckstyles.php' ;
//alert(FCKConfig.EditorPath + 'fckstyles.xml')
...
FCKConfig.FlashUploadDeniedExtensions	= ".(fla)$" ;					// empty for no one
