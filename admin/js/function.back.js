...
function doit() {
   ...
   function show(objet){
    ...
    if(document.all){
  		if(eval("framecontent").document.getElementById('wrapper')!=null){
  		  document.getElementById('wrapper').innerHTML=eval("framecontent").document.getElementById('wrapper').innerHTML;
        ...
        alert('Erreur au chargement, Veuillez contacter l\'administrateur si le problème persiste');
  		...
  		if(document.getElementById('framecontent').contentDocument.getElementById('wrapper')!=null){
  		//alert(document.getElementById('wrapper').innerHTML);
  		  document.getElementById('wrapper').innerHTML=document.getElementById('framecontent').contentDocument.getElementById('wrapper').innerHTML;
